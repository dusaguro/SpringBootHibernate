...
public class SpringdatajpaApplication implements CommandLineRunner {
	...
	public void perzonalizedQuieries2() {
		...
		personsRegs.forEach(reg -> {
			System.out.println("Lenguaje: " + reg[1] + ", Persona: " + reg[0]);
		});

		System.out.println("[========== Consultar Instancia Personalizada Nombre y Apellido ==========]");
		List<Person> persons = personRepository.findAllObjectPersonPersonalized();
		persons.forEach(System.out::println);

		System.out.println("[========== Consultar Instancia DTO Nombre y Apellido ==========]");
